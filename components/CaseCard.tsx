...
const CaseCard: React.FC<CaseCardProps> = ({ caseData, displayNumber, onReferenceClick, onHelp001Click, onTablesClick, onTableTestClick, onExosClick, t, tNotes, language, bgColorVar, isAnyFilterActive, isFirstCard }) => {
  ...
  const handleToggleDescription = (e: React.MouseEvent) => {
    ...
    const descriptionData = caseDescriptions[caseData.id]?.description;
    const descText = descriptionData?.[language] || descriptionData?.['es'] || t.description_not_found;
      ...
      <div style={{ backgroundColor: `var(${bgColorVar})` }} className={`p-5 flex-grow flex flex-col`}>
        <div className="mb-4">
          ...
          <div className="space-y-3">
            ...
            <div className={textColorClass} id={isFirstCard ? 'case-detail-icons-0' : undefined}>
              <CaseDetailIcons caseData={caseData} borderColorClass={borderColorClass} t={t} />
            </div>
          </div>
        </div>
